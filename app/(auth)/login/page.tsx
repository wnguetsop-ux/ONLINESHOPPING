...
// Detect PWA standalone mode (Play Store TWA, "Add to Home Screen")
// In this mode Google Sign-In must be hidden — use email/password only
...
export default function LoginPage() {
  ...
  // Detect WebView and PWA standalone on mount
  useEffect(() => {
    if (isWebView()) setWebViewWarning(true);
    if (isPWAStandalone()) setIsPlayStore(true);
  }, []);
