...
import { 
  ...
  SlidersHorizontal, Heart, Eye, Truck, Shield, RotateCcw, X, ChevronRight, Grid3X3, LayoutList, Settings
} from 'lucide-react';
...
export default function ShopPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50" style={{ paddingTop: 'env(safe-area-inset-top, 0px)' }}>
      {/* Header */}
      <header className="shop-header bg-white shadow-sm sticky top-0 z-40"
      ...
      {/* Admin floating button — only visible to the shop owner */}
      {user && adminShop?.slug === slug && (
        <Link
          href="/admin/dashboard"
          className="fixed z-50 flex items-center gap-2 px-4 py-3 rounded-2xl text-white shadow-lg text-sm font-semibold transition-all hover:scale-105 active:scale-95"
          style={{
